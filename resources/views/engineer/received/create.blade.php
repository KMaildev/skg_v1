                ...
                @foreach ($eng_request_items as $key => $request_info)
                    <div class="card invoice-preview-card m-2">
                        ...
                        <div class="table-responsive">
                            <form autocomplete="off" action="{{ route('fixed_assets_received_by_engineer') }}"
                                        ...
                                        @foreach ($request_info->eng_request_items_table as $key => $item)
                                            <tr>
                                                ...
                                                <td style="text-align: center;">
                                                    ...
                                                    @if ($received_qty == 0)
                                                        <input type="text" value="{{ $received_qty }}"
                                                            style="text-align:right;" name="received_qty[]">
                                                    @else
                                                        <input type="text" value="{{ $received_qty }}"
                                                            style="text-align:right;" name="received_qty[]" readonly>
                                                    @endif
                                                ...
                                                <td style="text-align: center;">
                                                    <input type="text" name="remark[]"
                                                        value="{{ $item->another_qs_team_check_passes_table->received_remark ?? '' }}">
                                                </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
