                        ...
                        <div class="card-body">
                            <div
                                ...
                                <div>
                                    ...
                                    @if ($request_info->qs_team_check_status != null)
                                        <div class="mb-2">
                                            <span class="me-1">Status:</span>
                                            <span class="fw-semibold" style="color: green">
                                                {{ $request_info->qs_team_check_status ?? '' }}
                                                @
                                                {{ $request_info->qs_team_check_date ?? '' }}
                                                By
                                                {{ $request_info->variable_qs_team_checks->users_table->name ?? '' }}
                                            </span>
                                        </div>
                                    @endif
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        ...
                                                        <input type="text" value="0" style="text-align:right;"
                                                            name="passed_qty[]" class="form-control">
                                                    </td>
