...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">Upload Payment Slip </h5>
                    <form class="card-body" autocomplete="off" action="{{ route('variable_finance.store') }}"
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreVariableFinancePaymentSlips', '#create-form') !!}
@endsection
