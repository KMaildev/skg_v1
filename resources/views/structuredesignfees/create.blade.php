...
@section('content')
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="col-xxl">
                <div class="card mb-4">
                    <h5 class="card-header">Structure Design Fees</h5>
                    <form class="card-body" autocomplete="off" action="{{ route('structuredesignfees.store') }}"
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreStructureDesignFees', '#create-form') !!}
@endsection
