        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <form class="card-body" autocomplete="off" action="{{ route('additional_work.store') }}" method="POST"
...
@section('script')
    {!! JsValidator::formRequest('App\Http\Requests\StoreAdditionalWork', '#create-form') !!}
    <script>
        $(function() {
