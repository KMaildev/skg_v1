        ...
        <div class="d-flex flex-column w-100">
            <div class="d-flex justify-content-between mb-1">
                ...
                <span class="text-muted">
                    @php
                        echo $project->archi_exterior_design_upload_date;
                    @endphp
                </span>
            </div>
            ...
            <div class="d-flex justify-content-between mb-1">
                ...
                <span>
                    <a href="{{ route('archiexteriordesign.show', $project->id) }}">
                        View File
                    </a>
                </span>

                <span>
                    <a href="{{ route('archiexteriordesigncreate.create', ['id' => $project->id]) }}">
                        Upload
...
@else
    ...
    @elseif($quotationProposalStatus == 'before')
        <li class="d-flex mb-2">
            <div class="avatar avatar-sm flex-shrink-0 me-3">
                <span class="avatar-initial rounded-circle bg-label-danger"><i class="bx bx-x"></i></span>
            </div>
            <div class="d-flex flex-column w-100">
                <div class="d-flex justify-content-between mb-1">
                    <span>No &nbsp;&nbsp;</span>
