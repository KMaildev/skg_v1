@if ($project->additional_work_status == null)
    <li class="d-flex mb-2">
        ...
        <div class="d-flex flex-column w-100">
            ...
            <div class="d-flex justify-content-end mb-1">
                <span>
                    <a href="{{ route('additional_work_create', ['id' => $project->id]) }}">
                        Upload
...
@else
    <li class="d-flex mb-2">
        ...
        <div class="d-flex flex-column w-100">
            ...
            <div class="d-flex justify-content-between mb-1">
                <span>
                    <a href="{{ route('additional_work.show', $project->id) }}">
                        View File
                    </a>
                </span>
