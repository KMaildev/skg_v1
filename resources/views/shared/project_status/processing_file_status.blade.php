@if ($project->processing_file == null)
    <li class="d-flex mb-2">
        ...
        <div class="d-flex flex-column w-100">
            ...
            <div class="d-flex justify-content-end mb-1">
                <span>
                    <a href="{{ route('createprocessingfile.create', ['id' => $project->id]) }}">
                        Upload
        ...
        <div class="d-flex flex-column w-100">
            <div class="d-flex justify-content-between mb-1">
                ...
                <span class="text-muted">
                    {{ $project->processing_file_upload_date }}
                </span>
            </div>
            <div class="progress" style="height:6px;">
            ...
            <div class="d-flex justify-content-between mb-1">
                <span>
                    <a href="{{ route('processingfile.show', $project->id) }}">
                        View File
                    </a>
                </span>
