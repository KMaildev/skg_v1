                ...
                <div class="col-md-6">
                    <div class="card">
                        ...
                        <div class="mb-3" style="margin: 20px;">
                            <form action="{{ route('un_leave_update') }}" method="POST" autocomplete="off"
                                id="create-form" role="form" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" value="{{ $employee->id }}" name="user_id" required>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control date_picker @error('leave_date') is-invalid @enderror"
                                            type="text" name="leave_date" value="{{ $employee->leave_date }}" />
                                        @error('leave_date')
                                            <div class="invalid-feedback"> {{ $message }} </div>
                                        @enderror
                                    </div>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-md-9">
                                        <input class="form-control @error('leave_remark') is-invalid @enderror"
                                            type="text" name="leave_remark" value="{{ $employee->leave_remark }}" />
                                        @error('leave_remark')
                                            <div class="invalid-feedback"> {{ $message }} </div>
                                        @enderror
                                    </div>
