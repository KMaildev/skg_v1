        ...
        <div class="col-md-6 col-lg-6 col-sm-12">
            ...
            <div class="col-xxl">
                <div class="card mb-4">
                    ...
                    <form class="card-body" autocomplete="off" action="{{ route('customers.update', $customer->id) }}"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('site_location') is-invalid @enderror"
                                    name="site_location" value="{{ $customer->site_location }}" />
                                @error('site_location')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('building_area') is-invalid @enderror"
                                    name="building_area" value="{{ $customer->building_area }}" />
                                @error('building_area')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('construction_type') is-invalid @enderror"
                                    name="construction_type" value="{{ $customer->construction_type }}" />
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('job_scope') is-invalid @enderror"
                                    name="job_scope" value="{{ $customer->job_scope }}" />
                                @error('job_scope')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('storeyed') is-invalid @enderror"
                                    name="storeyed" value="{{ $customer->storeyed }}" />
                                @error('storeyed')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control @error('project_code') is-invalid @enderror"
                                    name="project_code" value="{{ $customer->project_code }}" />
                                @error('project_code')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-9">
                                <textarea id="basic-default-message"
                                    ...
                                    name="remark">{{ $customer->remark }}</textarea>
                                @error('remark')
                                    <div class="invalid-feedback"> {{ $message }} </div>
                                @enderror
                            </div>
